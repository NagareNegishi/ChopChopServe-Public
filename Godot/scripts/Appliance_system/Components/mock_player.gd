...
#----------------------------------------------------------
# Added small change here
var original_item_scale: Vector3 = Vector3.ONE
#----------------------------------------------------------
...
#----------------------------------------------------------
# Added small change here
	original_item_scale = item.scale
	var original_global_scale = Vector3.ONE
	if item.is_inside_tree():
		original_global_scale = item.global_transform.basis.get_scale()
#----------------------------------------------------------
...
#----------------------------------------------------------
# Added small change here
	item_in_hand.scale = original_item_scale
#----------------------------------------------------------
